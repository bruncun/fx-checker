...
export const iconAssets = {
  ...
  close: {
    ...
    dark: {
      body: (
        <path
          fill="#fff"
          d="M12.773 4.287 9.06 8l3.713 3.713a.75.75 0 0 1 0 1.06.75.75 0 0 1-1.06 0L8 9.06l-3.713 3.713a.75.75 0 0 1-1.06-1.06L6.94 8 3.227 4.287a.75.75 0 0 1 1.06-1.06L8 6.94l3.713-3.713a.75.75 0 0 1 1.06 1.06Z"
        />
      ),
      height: 16,
      viewBox: "0 0 16 16",
  ...
  sun: {
    ...
    light: {
      body: (
        <g stroke="#050a2f" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
          <path d="M8 10.67A2.67 2.67 0 1 0 8 5.33a2.67 2.67 0 0 0 0 5.34ZM8 .67V2M8 14v1.33M2.82 2.82l.94.94M12.24 12.24l.94.94M.67 8H2M14 8h1.33M2.82 13.18l.94-.94M12.24 3.76l.94-.94" />
        </g>
      ),
      height: 16,
  ...
  system: {
    ...
    dark: {
      body: (
        <path
          fill="#fff"
          d="M2.67 2.17h10.66c.74 0 1.34.6 1.34 1.33v6.33c0 .74-.6 1.34-1.34 1.34H9.08v1.5h2.09c.23 0 .41.18.41.41v.5c0 .23-.18.42-.41.42H4.83a.42.42 0 0 1-.41-.42v-.5c0-.23.18-.41.41-.41h2.09v-1.5H2.67c-.74 0-1.34-.6-1.34-1.34V3.5c0-.73.6-1.33 1.34-1.33Zm0 1.33v5.83h10.66V3.5H2.67Z"
        />
      ),
      height: 16,
      viewBox: "0 0 16 16",
...
function Icon({
  ...
  return (
    <span
      ...
      style={{
        ...style,
        height: height ?? style?.height ?? asset.dark.height,
        width: width ?? style?.width ?? asset.dark.width,
      }}
      {...props}
    >
      <IconSvg className="fx-themed-icon-dark" variant={asset.dark} />
      <IconSvg className="fx-themed-icon-light" variant={asset.light} />
    </span>
  );
}
